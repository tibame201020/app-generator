  ...
  return (
    <div className="navbar bg-base-100 shadow-md">
      <div className="flex-1">
        <a className="btn btn-ghost text-xl normal-case">Jules Software Factory</a>
        <span className="badge badge-primary ml-2">Phase 4: Frontend UI</span>
      </div>
        ...
        <div className="dropdown dropdown-end">
          <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
            <div className="w-10 rounded-full">
              <img src="https://ui-avatars.com/api/?name=Jules&background=random" alt="Avatar" />
            </div>
          </label>
