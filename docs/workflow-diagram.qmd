...
digraph G {
    ...
    fontname="Arial"
    fontsize=24
    label="Autonomous Software Factory: Full Workflow"
    labelloc="t"
    ...
    User [shape=circle, label="👩‍💻 Human", fillcolor="#e1f5fe", width=1.5]
    ...
    subgraph cluster_0 {
        ...
        Orchestrator [label="🏁 Factory Orchestrator", fillcolor="#fff9c4"]
        ReqAnalyst [label="📝 Requirements Analyst"]
        VisualDesigner [label="🎨 Visual Designer", style="filled,dashed,rounded", fillcolor="#ffffff"]
    ...
    subgraph cluster_1 {
        ...
        Architect [label="🏛️ Architect Reviewer"]
        Simulation [label="🧠 Mental Simulation", shape=ellipse, fillcolor="#ffffff"]
    }
    ...
    subgraph cluster_2 {
        ...
        Iterator [label="🏭 Factory Iterator"]
        Tracker [label="🗄️ tracker.json", shape=note, fillcolor="#ffffff"]
        Workers [label="👷 Worker Agents"]
    }
    ...
    subgraph cluster_3 {
        ...
        Repair [label="🩹 Self-Healing", fillcolor="#ffccbc"]
        Merge [label="✅ Merge & Advance", fillcolor="#c8e6c9"]
    }
